...
public final class user_005fhome_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <nav class=\"navbar navbar-default\" role=\"navigation\" style=\"border:hidden ;background-color:#2E9AFE;width: 100%;margin: -1\">\n");
      ...
      out.write("              </button>\n");
      out.write("\n");
      out.write("            <div class=\"navbar-brand\" style=\"padding-top:0px;\"><img  src=\"img/logo_nav.gif\" style=\"height:140%;width50%;\"/></div>\n");
      out.write("\n");
      out.write("            </div>\n");
      ...
      out.write("                <script>\n");
      out.write("                  /*This part of code is to represent the canvas on the home page*/\n");
      ...
      out.write("                        <div class=\"progress-bar progress-bar-striped active\"  role=\"progressbar\" aria-valuenow=\"60\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width:");
      out.print( percentage );
      ...
      out.write("                            <div class=\"radio\">\n");
      out.write("                                <label>\n");
      out.write("                                    <input type=\"radio\" name=\"recur\" id=\"none\" value=\"none\">\n");
      out.write("                                    None\n");
      out.write("                                </label>\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      ...
      out.write("\n");
      out.write("\ti = 0;\n");
      out.write("        //Here we simply obtain the current system date\n");
      out.write("\tvar date = new Date();\n");
      out.write("        date.setDate(date.getDate());\n");
      out.write("        \n");
      out.write("        //Here the datepicker is initialized with past dates disabled and hide on date select\n");
      out.write("\t $(function () {\n");
      out.write("                $(\"#duedate\").datepicker({startDate: date});\n");
      out.write("                \n");
      out.write("                $('#duedate').on('changeDate', function(ev){\n");
      out.write("                    $(this).datepicker('hide');\n");
      out.write("                });\n");
      out.write("            });\n");
      out.write("            \n");
      out.write("          //This function displays a chart showing the progress of all your friends in terms of points.  \n");
      ...
      out.write("                for (i=0;i<list.length;i++)\n");
      out.write("               {\n");
      out.write("                   //console.log(list[i]-list2[i]);\n");
      ...
      out.write("              }\n");
      out.write("              else if(response==\"false1\")\n");
      out.write("              {\n");
      out.write("                   $(\"#searchUpdate\").text(\"You can't add yourself\");\n");
      ...
      out.write("        });\n");
      out.write("\t\n");
      out.write("        //This function is called when tbe user logs out, calling  a cookie cleaner servlet.\n");
      ...
      out.write("                            validators: {\n");
      out.write("                                notEmpty: {\n");
      out.write("                                    message: 'Dats is required'\n");
      out.write("                                },\n");
      out.write("                            }\n");
      out.write("                        },\n");
      out.write("                    }\n");
